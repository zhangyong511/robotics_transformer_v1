...
BASE_WEIGHTS_PATH = '/mnt/ve_share2/zy/robotics_transformer/film_efficientnet/efficientnet_checkpoints/efficientnet'
IMAGENET_JSON_PATH = '/mnt/ve_share2/zy/robotics_transformer/film_efficientnet/efficientnet_checkpoints/imagenet_classes.json'
CLASS_INDEX = None
...
def EfficientNet(width_coefficient,
  ...
  if weights == 'imagenet':
    ...
    model.load_weights(weights_path, skip_mismatch=False, by_name=False)   ###zy 卡在这里
