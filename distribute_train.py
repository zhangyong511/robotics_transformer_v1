...
def get_args():
    ...
    parser.add_argument('--training_epoch', '-te', help='training epoch', default=2, type=int)  # 训练epoch
    parser.add_argument('--log_step', '-ls', help='log step', default=10, type=int)
    parser.add_argument('--dataset_dirs', '-d', help='dataset path', default="/mnt/ve_share2/zy/language_table_embedding/language_table_use/1.0.0")
